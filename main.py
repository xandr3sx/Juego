...
def main(page: ft.Page):
    ...
    db_preguntas = {
        ...
        "Extremo": {
            ...
            "reto": [
                "Simula una posición del Kamasutra con la almohada.",
                "Véndame los ojos y haz lo que quieras por 2 minutos.",
                "Quítate la ropa interior y dámela.",
                "Déjame atarte las manos por 3 turnos.",
                "Tómame (o haz que te tome) sin parar durante 7 minutos en la posición que yo elija.",
                "Usa mi boca para oral profundo extremo hasta que me salten lágrimas de placer.",
                "Ata mis manos a la espalda y azótame fuerte el culo mientras me tomas por detrás.",
                "Incorpora fluidos intensos: escúpeme en la boca o cara mientras llegamos al clímax.",
                "Rolea puro CNC: inmovilízame y tómame con fuerza total hasta el orgasmo.",
                "Explora atrás profundo: usa dedos, lengua o juguete mientras tomas la otra entrada.",
                "Llévame al squirting/eyaculación múltiple con dedos y oral sin parar.",
                "Humíllame fuerte verbalmente mientras me tomas en perrito agarrándome del pelo.",
                "Usa cera caliente o hielo extremo en pezones y genitales, seguido de sexo.",
                "Edging brutal durante 10 minutos, llevándome al borde y parando repetidamente.",
                "Átame los ojos y sorpréndeme alternando dolor (azotes) y placer (oral) 8 minutos.",
                "Tómame fuerte contra la pared, levantándome si hace falta, sin bajar ritmo.",
                "Haz que te use la boca profundo mientras te agarro la cabeza 5 minutos seguidos.",
                "Azótame 30 veces fuerte contando en voz alta, luego tómame inmediatamente.",
                "Doble juego: dedos o juguete atrás mientras me tomas genitalmente.",
                "Oblígame a mirarte a los ojos mientras te corres dentro de mí muy profundo.",
                "Escúpeme en la boca repetidamente durante un beso sucio y sexo intenso.",
                "Usa cera caliente goteando en mi espalda y culo, luego tómame salvajemente.",
                "Inmovilízame y haz overstimulation después de mi primer orgasmo sin parar.",
                "Edging mutuo: nos llevamos al borde el uno al otro 5 veces sin dejar acabar.",
                "Tira de mi pelo fuerte mientras me tomas por detrás en posición animal.",
                "Oblígame a masturbarme frente a ti sin correrme hasta que tú digas.",
                "Araña y muerde mi espalda y culo fuerte mientras me tomas.",
                "Sexo en posición dolorosamente profunda durante 10 minutos seguidos.",
                "Mezcla sudor y saliva lamiéndome entero antes de tomarme fuerte.",
                "Choking ligero con tu mano mientras me tomas al máximo ritmo.",
                "Repite la posición que más orgasmo brutal me ha dado, pero más intenso.",
                "Usa un juguete grande para estirarme antes o durante el acto.",
                "Humíllame con nombres sucios mientras me haces correrme fuerte.",
                "Tómame exhaustivamente hasta que los dos estemos temblando.",
                "Átame y juega con hielo dentro de mí antes de entrarme caliente.",
                "Oral profundo con garganta hasta que no pueda más, luego sexo.",
                "Azotes suaves en genitales alternando con lamidas intensas.",
                "Sexo maratónico: cambia de posición cada vez que estemos al borde.",
                "Lámeme una zona entera durante 10 minutos sin parar.",
                "Breath play suave: tapa mi boca/nariz momentos durante el clímax.",
                "Marca todo mi cuerpo con chupetones y mordidas visibles.",
                "Oblígame a múltiples orgasmos seguidos sin descanso entre ellos.",
                "Entra en mí justo después de correrme para overstimulation máxima.",
                "Usa tus uñas para arañar mientras llegamos al orgasmo juntos.",
                "Niega mi orgasmo 8 veces seguidas antes de permitírmelo explosivo.",
                "Sexo anal completo y profundo hasta el final.",
                "Oral en 69 con competencia de quién aguanta más al borde.",
                "Tómame con las piernas arriba contra la pared, máxima profundidad.",
                "Humillación constante susurrada al oído durante todo el acto.",
                "Alterna ritmo rápido y lento para volverme loco/a.",
                "Haz que te monte mientras me azotas y tiras del pelo.",
                "Termina corriéndote en mi cara o cuerpo y oblígame a limpiar con la boca.",
                "Sesión completa de dominación total: tú decides todo durante 15 minutos.",
                "Final épico: sexo intenso hasta que los dos colapsemos de placer."
            ],
            "castigo": [
    ...
    def cargar_juego():
        ...
        btn_girar = ft.Container(
            ...
            on_click=lambda _: logica_ruleta(),
        ...
        btn_dados = ft.IconButton(
            ...
            on_click=lambda _: mostrar_dados()
        )
        ...
        btn_completado = ft.ElevatedButton(
            ...
            visible=False, 
            on_click=lambda _: completar_reto()
        )
        ...
        contenido_juego = ft.Container(
            ...
            content=ft.Column([
                # CABECERA MÓVIL
                ft.Row([
                    ft.IconButton(ft.Icons.ARROW_BACK, icon_color="white", on_click=lambda _: cargar_dificultad()),
                    texto_turno, # Centro
    ...
    def cargar_dificultad():
        ...
        def crear_tarjeta_nivel(texto, gradiente, icono):
            return ft.Container(
                ...
                border=ft.border.all(1, ft.Colors.WHITE24),
                border_radius=20,
                on_click=lambda _: seleccionar(texto),
        ...
        contenido = ft.Container(
            ...
            width=page.window_width, height=page.window_height,
            content=ft.Column([
                ft.IconButton(ft.Icons.ARROW_BACK, icon_color="white", on_click=lambda _: cargar_login()),
